...
var quizApp = function() {
	...
	this.showResult = function(scr) {
		...
		$("#result").html("<h1 class='res-header'>Total Score: &nbsp;" + scr  + '/' + totalque + "<button style='float:right;' class='btn btn-success' onclick='window.location.href=window.location.href'>Play Again</button></h1>");
