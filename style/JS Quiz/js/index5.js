...
var quizApp = function() {
	...
	this.showResult = function(scr) {
		...
		$("#result").html("<h1 class='res-header'><button style='float:left;' class='btn btn-success' onclick='window.location.href=window.location.href'>Play Again</button>Total Score: &nbsp;" + scr  + '/' + totalque + "</h1>");
